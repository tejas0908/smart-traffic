...
import argparse
import glob
classes = [c.strip() for c in open('/data/coco/classes.txt').readlines()]
...
if __name__ == '__main__':
    ...
    args = parse_args()
    rootdir = '/home/ctolabs/softwares/py-faster-rcnn-coco/output/faster_rcnn_alt_opt/trainval'
    ...
    im_names = glob.glob('/home/ctolabs/data/test_images/*.jpg')
