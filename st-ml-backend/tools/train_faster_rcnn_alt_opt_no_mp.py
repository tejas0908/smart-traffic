...
if __name__ == '__main__':
    ...
    rpn_stage1_out['proposal_path']  = rpn_generate(
            queue=mp_queue,
            imdb_name=args.imdb_name,
            rpn_model_path=str(rpn_stage1_out['model_path']),
            cfg=cfg,
            rpn_test_prototxt=rpn_test_prototxt)['proposal_path']
    ...
    cfg.TRAIN.SNAPSHOT_INFIX = 'stage1'
    fast_rcnn_stage1_out = train_fast_rcnn(
            queue=mp_queue,
            imdb_name=args.imdb_name,
            init_model=args.pretrained_model,
            solver=solvers[1],
    ...
    rpn_stage2_out['proposal_path'] = rpn_generate(
            queue=mp_queue,
            imdb_name=args.imdb_name,
    ...
    cfg.TRAIN.SNAPSHOT_INFIX = 'stage2'
    fast_rcnn_stage2_out = train_fast_rcnn(
            queue=mp_queue,
            imdb_name=args.imdb_name,
